...
export const ENTITY_RELATIONS = [
  "Пользователь хранит Критерии, Методики и матрицы парных сравнений методик (МАИ, шкала сравнений).",
  ...
  "Рекомендация — методика с максимальным глобальным приоритетом; проверка КС < 0,1.",
];
